...
function MarketTokenSelectorInternal(props: Props) {
  ...
  const thClassName = cx(
    "text-body-medium sticky top-0 z-10 border-b bg-main-bgLightest border-main-border text-left font-normal uppercase text-gray-400 last-of-type:text-right",
